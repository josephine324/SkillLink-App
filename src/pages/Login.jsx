  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-r from-blue-500 to-purple-600">
      <div className="w-full max-w-md px-8 py-10 mx-4 mt-4 bg-white rounded-lg shadow-lg">
        <h3 className="mb-4 text-3xl font-bold text-center text-gray-800">
        ...
        <form onSubmit={handleLogin}>
          <div className="mt-4">
            ...
            <div className="flex items-center justify-between mt-6">
              <button
                type="submit"
                className={`flex items-center justify-center w-full px-4 py-2 text-white transition duration-300 ease-in-out transform bg-blue-600 rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 ${
